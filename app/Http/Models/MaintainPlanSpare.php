...
class MaintainPlanSpare extends  Base
{
    public function __construct()
    {
        $this->table='ruis_maintain_spare_item';

        //定义表别名
        $this->aliasTable=[
            'maintainspare'=>$this->table.' as maintainspare',
        ];
	...
	{
		$resarr  = json_decode($input['spareitems'],true);
