...
use App\Http\Models\RequirePlan;
use App\Http\Models\RequirePlanItem;


class RequirePlanController extends Controller{
    ...
    {
      parent::__construct();
      if(empty($this->model)) $this->model =new RequirePlan();
      if(empty($this->instoreitem)) $this->instoreitem =new RequirePlanItem();
    }
