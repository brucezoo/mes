...
use App\Http\Models\SpareReceive;
use App\Http\Models\SpareReceiveItem;


class SpareReceiveController extends Controller{
    ...
    {
      parent::__construct();
      if(empty($this->model)) $this->model =new SpareReceive();
      if(empty($this->instoreitem)) $this->instoreitem =new SpareReceiveItem();
    }
