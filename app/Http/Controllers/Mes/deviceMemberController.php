...
use App\Http\Models\DeviceMember;       //设备台账model

class deviceMemberController extends Controller
{
    ...
    {
      parent::__construct();
      if(empty($this->model)) $this->model=new DeviceMember();
    }
