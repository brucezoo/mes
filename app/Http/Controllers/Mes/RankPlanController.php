...
use App\Http\Models\RankPlan;

class RankPlanController extends Controller{

    public function __construct()
    {
        parent::__construct();
        if(!$this->model) $this->model = new RankPlan();
    }
...
//region 查
    ...
    public function pageIndex(Request $request){
        ...
        $obj_list = $this->model->getRankPlanListByPage($input);
    ...
    public function select(Request $request){
        $input = $request->all();
        $obj = $this->model->getRankPlanList($input);
        return response()->json(get_success_api_response($obj));
    }
