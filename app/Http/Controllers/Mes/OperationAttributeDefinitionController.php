...
use App\Http\Models\OperationAttributeDefinition;
 ...
 * @time    2017年09月25日
 */
class OperationAttributeDefinitionController extends Controller
{

    public function __construct()
    {
        parent::__construct();
        if(empty($this->model)) $this->model=new OperationAttributeDefinition();
    }
...
//region 查
    ...
    public function  pageIndex(Request $request)
    {
        ...
        //获取数据
        $obj_list=$this->model->getAttributeList($input);
        //获取返回值
...
//region 增
    ...
    public function store(Request $request){
        ...
        $insert_id=$this->model->add($input,config('app.category.operation'));
        //返回前端
