...
use App\Http\Models\MaintainPlan;
use App\Http\Models\MaintainPlanDevice;
use App\Http\Models\MaintainPlanItem;
use App\Http\Models\MaintainPlanSpare;


class MaintainPlanController extends Controller{
    ...
    {
      parent::__construct();
      if(empty($this->model)) $this->model =new MaintainPlan();
      if(empty($this->maintaindevice)) $this->maintaindevice =new MaintainPlanDevice();
      if(empty($this->maintainitem)) $this->maintainitem =new MaintainPlanItem();
