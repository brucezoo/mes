...
class OapiSmartdeviceFacegroupMemberUpdateRequest
{
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->addUserIds,"addUserIds");
		...
		RequestCheckUtil::checkNotNull($this->delUserIds,"delUserIds");
		RequestCheckUtil::checkMaxListSize($this->delUserIds,20,"delUserIds");
	}
