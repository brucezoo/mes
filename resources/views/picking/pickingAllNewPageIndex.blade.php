...
@section("page-main")
    <div class="div_con_wrapper">
        <a href="/PickingAll/addPickingAllNewItems"><button class="button"><i class="fa fa-plus"></i>添加</button></a>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/picking/pickingAllNewPageIndex.js?v={{$release}}"></script>
