        ...
        <div class="tap-btn-wrap">
            <div class="el-form-item btnShow saveBtn">
                <div class="el-form-item-div btn-group">
                    ...
                    <button type="button" class="el-button el-button--primary submit delete is-disabled" style="display: none">删除未发料行项</button>
            ...
            <div class="basic_info">
                <div class="table-container">
                    <table class="storage_table item_table table-bordered">
                        <thead>
                        <tr>
                            <th  class="thead" id="salere">特殊库存</th>
                            <th  class="thead" id="showCombine" >合并工单</th>
                            ...
                            <th  class="thead" id="rbqty">需求数量</th>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/product_order/view_picking_list_all.js?v={{$release}}"></script>
