...
@section("page-main")
    <div class="div_con_wrapper">
        <div class="actions">
            <button class="button button_action button_add" data-company-id="15" data-id="15" data-flag="company"><i class="fa fa-plus"></i>添加</button>
        </div>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/qc/invalidCost/qcDepartmentLists.js?v={{$release}}"></script>
@endsection
