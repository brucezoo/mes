                  ...
                  <div class="el-select-dropdown-wrap">
                    ...
                    <div class="el-select-dropdown">
                      <ul class="el-select-dropdown-list">
                        ...
                        <li data-id="1" data-code="" class=" el-select-dropdown-item">--待处理--</li>
                        <li data-id="2" data-code="" class=" el-select-dropdown-item">--已处理--</li>
                        <li data-id="0" data-code="" class=" el-select-dropdown-item">--其他--</li>
                      </ul>
                    </div>
                  </div>
                </div>
...
<script src="/statics/custom/js/qc/invalidCost/invalidCostCheckList.js?v={{$release}}"></script>
