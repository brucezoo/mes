...
<div class="div_con_wrapper">
	<div class="actions">
		<a href="/QC/invalidCostIndex"><button id="storage_add" class="button button_action button_add">添加</button></a>
		<button type="button" style="margin-left: 30px;" class="layui-btn layui-btn-normal layui-btn-sm" id="test8">导入</button>
			...
			<div class="el-item">
								...
								<div class="el-form-item-div">
									...
									<div class="el-select-dropdown-wrap">
										<div class="el-select">
											<i class="el-input-icon el-icon el-icon-caret-top"></i>
											<input type="text" readonly="readonly" class="el-input" value="--请选择--">
											<input type="hidden" class="val_id" id="is_handle" value="0">
										</div>
										<div class="el-select-dropdown">
											<ul class="el-select-dropdown-list">
												<li data-id="" data-code="" data-name="--请选择--" class=" el-select-dropdown-item">--请选择--</li>
												<li data-id="1" data-code="" class=" el-select-dropdown-item">--处理中--</li>
												<li data-id="2" data-code="" class=" el-select-dropdown-item">--已处理--</li>
												<li data-id="0" data-code="" class=" el-select-dropdown-item">--待处理--</li>
											</ul>
										</div>
									</div>
								</div>
                ...
                <div class="el-form-item-div">
                  ...
                  <div class="el-select-dropdown-wrap">
                    ...
                    <div class="el-select-dropdown">
                      <ul class="el-select-dropdown-list">
                        <li data-id="" data-code="" data-name="--请选择--" class=" el-select-dropdown-item">--请选择--</li>
                        <li data-id="0" data-code="" class=" el-select-dropdown-item">失效提报</li>
                        <li data-id="1" data-code="" class=" el-select-dropdown-item">索赔单</li>
                      </ul>
                    </div>
                  </div>
                </div>
				...
				<div class="el-form-item">
					<div class="el-form-item-div btn-group" style="margin-top: 10px;">
						...
						<a id='exportExcel' style="margin-left:10px;"><button type="button" class="el-button export">导出</button></a>
						<button type="button" class="el-button push" style="margin-left:10px;">推送</button>
					</div>
				</div>
			</div>
		</form>
			...
			<table id="table_otherinstore_table" class="sticky uniquetable commontable">
				<thead>
					<tr>
						...
						<th class="left nowrap">处理状态</th>
						<th class="left nowrap">创建时间</th>
						<th class="left nowrap">处理时间</th>
...
<!-- <script src="/statics/common/layui/lay/modules/laydate.js"></script> -->
...
<script src="/statics/custom/js/qc/invalidCost/invalidCostList.js?v={{$release}}"></script>
