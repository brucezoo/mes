			...
			<div class="el-item">
				...
				<div class="el-form-item">
					<div class="el-form-item-div btn-group" style="margin-top: 10px;">
						...
						<!-- 添加导出按钮  mao -->
						<a href="#" id="load" style="margin-left: 10px;"><button type="button" class="el-button ">导出</button></a>
					</div>
				</div>
			</div>
		</form>
...
<script src="/statics/custom/js/qc/invalidCost/invalidList.js?v={{$release}}"></script>
