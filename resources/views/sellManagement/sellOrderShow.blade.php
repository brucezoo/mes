			...
			<div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="customerNum" class="el-input" placeholder="请选择客户编码" value="">
				...
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="customerName" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="company" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
			...
			<div>
                <div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="code" class="el-input" placeholder="请输入销售单编码" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="position" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
				...
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="phonenum" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
				...
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="email" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
			...
			<div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="address" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						...
						<input type="text" readonly="readonly" id="lable" class="el-input" placeholder="" value="">
					</div>
					<p class="errorMessage" style="padding-left: 30px;"></p>
				</div>
				<div class="el-form-item">
...
<script src="/statics/custom/js/sellsManagement/sellOrder-view.js?v={{$release}}"></script>
@endsection