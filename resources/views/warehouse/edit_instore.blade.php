	...
	<div class="storage_blockquote">
		...
		<div class="basic_info">
			<div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						<label class="el-form-item-label">入库单编码<span class="mustItem">*</span></label>
						<input type="text" id="code" class="el-input" readonly="readonly" placeholder="请输入编码" value="">
					</div>
			...
			<div>
				<div class="el-form-item">
					<div class="el-form-item-div">
						<label class="el-form-item-label">入库原因<span class="mustItem">*</span></label>
						<textarea type="textarea" maxlength="500" id="remark" rows="5" class="el-textarea" placeholder="请输入入库原因，最多只能输入500字"></textarea>
					</div>
					<p class="errorMessage" style="padding-left: 20px;"></p>
				</div>
			</div>
...
<script src="/statics/custom/js/storage/storage-otherinstore-edit.js?v={{$release}}"></script>
@endsection