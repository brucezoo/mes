...
<div class="div_con_wrapper">
    <div class="actions">
        <button id="use_add" class="button"><i class="fa fa-plus"></i>添加</button>
    </div>

    <div class="table_page">
        <div class="wrap_table_div" style="overflow: hidden;min-height: 500px;">
            <table id="use_table" class="sticky uniquetable">
                <thead>
                <tr>
...
<script src="/statics/custom/js/procedure/use.js"></script>
@endsection
