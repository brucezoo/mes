...
<div class="div_con_wrapper">
    <div class="actions">
        <a href="/ImageManagement/addCareLabel"><button class="button button_action button_add"><i class="fa fa-plus"></i>添加</button></a>
        <button class="button button_action" id="load" ><a href="" id="loada">批量下载</a></button>
    </div>
            ...
            <div class="el-item">
                <div class="el-item-show">
                        ...
                        <div class="el-form-item">
                            ...
                            <div class="el-form-item">
                                <div class="el-form-item-div">
                                    ...
                                    <input type="text" id="line_project_code" class="el-input" placeholder="请输入销售行项号" value="">
                                </div>
                            </div>
                        </li>
                        ...
                        <!--<li>-->
                            <!--<div class="el-form-item template_attr" style="">-->
                                <!--<div class="el-form-item-div">-->
                                    ...
                                    <!--</div>-->
                                    <!--&lt;!&ndash;<input type="text" id="material_attr_id"  class="el-input" placeholder="" value="">&ndash;&gt;-->
                                <!--</div>-->
                            <!--</div>-->
                        <!--</li>-->
                    ...
                    <li>
                            <div class="el-form-item">
                                <div class="el-form-item-div">
                                    <label class="el-form-item-label" style="width: 109px;">国家</label>
                                    <select name="" id="city" style="width: 283px;height:36px;">
    ...
    <div class="table_page">
        <div class="wrap_table_div">
            <table id="image_table" class="uniquetable commontable">
                <thead>
                <tr>
                    <th><input type="checkbox" name="like[read]"  id = "all-choice" > 全选</th>
                    <th>缩略图</th>
                    <th>图纸编码</th>
                    <th>图纸名称</th>
                    <th>图纸来源</th>
...
<script src="/statics/common/el/FileSaver.js?v={{$release}}"></script>
...
<script src="/statics/common/el/pdf.worker.js?v={{$release}}"></script>
<script src="/statics/custom/js/image/image-url.js?v={{$release}}"></script>
<script src="/statics/common/pagenation/pagenation.js?v={{$release}}"></script>
<script src="/statics/common/laydate/laydate.js"></script>
<script src="/statics/custom/js/image/careLabel.js?v={{$release}}"></script>
@endsection
