...
<link type="text/css" rel="stylesheet" href="/statics/custom/css/test/split.css?v={{$release}}">
@endsection
	    ...
	    <div class="right">
	    	...
	    	<div class="wt-wrap">
				...
				<div class="split-wrap">
					<div class="action">
						<div class="equal">
							<input type="number" class="el-input" id="wt-input" placeholder="请输入数量">
...
<script src="/statics/custom/js/test/aps-url.js?v={{$release}}"></script>
<script src="/statics/common/laydate/laydate.js"></script>
<script src="/statics/custom/js/test/split.js?v={{$release}}"></script>
@endsection
