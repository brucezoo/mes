  ...
  <form class="formModal formWorkOrder" id="workOrder_from" >
    <div class="work_order_text">
      ...
      <div class="el-form-item work_order_button" style="flex:6;">
        <button type="button" class="el-button el-button--primary print-batch is-disabled" style="color:#fff;width:120px;height:40px;margin: 0 5px;font-size:22px;">打印</button>
      </div>
    </div>
    ...
    <div class="" style="border: solid 1px #d1dbe5;height:80px;line-height:80px;padding: 5px;margin-bottom:10px;display:flex;">
      <div style="flex:2;font-size:22px;font-weight:600;">计划数量</div>
      <div style="flex:4;font-size:22px;font-weight:600;" id="plan_qty"></div>
      <div style="flex:2;font-size:22px;font-weight:600;">累计数量</div>
      <div style="flex:4;font-size:22px;font-weight:600;" id="serial_code_num"></div>

    </div>
    <div class="work_order_wrap" style="display:block;">
...
<script type="text/javascript" src="/statics/custom/js/batch/traceBackFinishedBatch.js?v={{$release}}"></script>
