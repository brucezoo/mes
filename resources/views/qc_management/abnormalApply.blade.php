...
@section("page-main")
    <div class="div_con_wrapper">
        <div class="actions">
            <button class="button button_action button_check"><i class="fa fa-add"></i>异常申请</button>
        </div>
                            ...
                            <li>
                                <div class="el-form-item">
                                    <div class="el-form-item-div">
                                        ...
                                        <input type="text" id="NAME1" class="el-input" placeholder="请输入供应商" value="">
                                    </div>
                                </div>
                                <div class="el-form-item">
                                    <div class="el-form-item-div">
                                        <label class="el-form-item-label">责任单位</label>
                                        <input type="text" id="responsibleUnit" class="el-input" placeholder="请输入责任单位" value="">
                                    </div>
                                </div>
                            </li>
                        </ul>
