                ...
                <div class="el-panel addBBasic_from active">
                    ...
                    <form id="addBBasic_from" class="formTemplate formBom normal">
                        <div style="width: 800px; padding: 20px;margin-top: 20px;">
                            <input type="hidden" id="complaimt_id">
                            <input type="hidden" id="complaimt_dThree">
                            ...
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    ...
                                    <input type="text" id="received_date"   data-name="接收日期" class="el-input" placeholder="接收日期" >
                                </div>
                            </div>
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    <label class="el-form-item-label" style="width: 100px;">不良品接收日期</label>
                                    <input type="text" id="samples_received_date"   data-name="不良品接收日期" class="el-input" placeholder="不良品接收日期" >
                                </div>
                            </div>
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    <label class="el-form-item-label" style="width: 100px;">缺陷比</label>
                                    <input type="text" id="defect_rate" onblur="value=value.replace(/\-/g,'')"  data-name="缺陷比"  class="el-input" placeholder="缺陷比" >
                                </div>
                            </div>
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                            ...
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                  <div class="el-form-item-div">
                                      ...
                                      <div class="el-select-dropdown-wrap customer_type">
                                          <div class="el-select">
                                              <i class="el-input-icon el-icon el-icon-caret-top"></i>
                                              <input type="text" readonly="readonly" class="el-input" value="--请选择--">
                            ...
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    ...
                                    <textarea type="textarea"  maxlength="500"  id="defect_description" rows="5" class="el-textarea" placeholder="描述"></textarea>
                                </div>
                            </div>
                        ...
                        <div style="width: 800px; padding: 20px;margin-top: 20px;">
                                    ...
                                    <div class="el-select-dropdown-wrap">
                                        ...
                                        <div class="el-select-dropdown">
                                            <ul class="el-select-dropdown-list">
                                                ...
                                                <li data-id="5" data-code="" data-name="--少件，给客户补发产品--" class=" el-select-dropdown-item">--少件，给客户补发产品--</li>
                                            </ul>
                                        </div>
                            ...
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    ...
                                    <input type="text" id="next_shipment_schedule_time"   data-name="计划送货时间" class="el-input" placeholder="计划送货时间" >
                                </div>
                            </div>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/qc/complaint/qc-edit-complaint-item.js?v={{$release}}"></script>
