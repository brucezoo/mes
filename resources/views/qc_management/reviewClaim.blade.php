      ...
      <div class="flex-wrap" style="width: 1314px">
        <div class="basic-wrap" style="border:1px solid #ddd;">
          <div style="text-align: center;padding-top:50px;padding-bottom: 20px;">
            <h2 style="margin-bottom: 20px;">索赔单审核</h2>
          ...
          <div class="save-item" style="margin-top: 20px;">
            ...
            <div class="el-form-item" style="width:50%;">
              <div class="el-form-item-div">
                ...
                <input type="text" id="dealCost" class="el-input" placeholder="请输入处理费用" value="" />
              </div>
            </div>
            ...
            <div class="el-form-item">
              <div class="el-form-item-div" style="width: 1190px;">
                ...
                <textarea type="textarea" maxlength="500" id="questionDescription" rows="5" class="el-textarea" placeholder="请输入问题描述，最多只能输入500字符">
              </textarea>
              </div>
            ...
            <div class="el-form-item">
              <div class="el-form-item-div" id="specialPurchase">
                <label class="el-form-item-label" style="width: 110px;">是否同意索赔</label>
            ...
            <div class="el-form-item">
              <div class="el-form-item-div" style="width: 1190px;">
                <label class="el-form-item-label" style="width: 100px;">回复内容</label>
                <textarea type="textarea" maxlength="500" id="review_desc" rows="5" class="el-textarea" placeholder="请输入回复内容，最多只能输入500字符">
                </textarea>
              </div>
            </div>
            <div class="el-form-item">
              <div class="el-form-item-div" style="width: 1190px;">
                <label class="el-form-item-label" style="width: 100px;">审核人回复<span class="mustItem"></span></label>
                <textarea type="textarea" maxlength="500" id="review_desc1" rows="5" class="el-textarea" placeholder="" readonly="true">
                </textarea>
              </div>
            </div>
          </div>
...
<script src="/statics/custom/js/qc/qc_inspection/reviewclaim.js?v={{$release}}"></script>
