                                ...
                                <li>
                                    ...
                                    <div class="el-form-item">
                                        <div class="el-form-item-div">
                                            ...
                                            <input type="text" id="cn_name" class="el-input" placeholder="请输入审核人" value="">
                                        </div>
                                    </div>
                                </li>
                                <li>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/qc/outsourceReview/outsourceReviewList.js?v={{$release}}"></script>
