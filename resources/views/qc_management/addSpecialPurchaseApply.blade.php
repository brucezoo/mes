                        ...
                        <div class="el-form-item">
                            <div class="el-form-item-div">
                                <label class="el-form-item-label" style="margin-bottom: 0px;">
                                    <span class="button pop-button choose-admin" style="cursor: pointer;position: relative;left: 25px;padding: 5px 4px;">选择审核人</span>
                                </label>
                                <input type="text" id="choose_admin"  class="el-input" style="margin-left: 55px;" placeholder="请选择审核人" value="" readonly>
...
<script src="/statics/custom/js/qc/deviation/addSpecialPurchaseApply.js?v={{$release}}"></script>
