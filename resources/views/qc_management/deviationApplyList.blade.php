						...
						<li>
							<div class="el-form-item">
								<div class="el-form-item-div">
									...
									<input type="text" id="gys_name" class="el-input" placeholder="请输入供应商名称" value="">
								</div>
							</div>
							<div class="el-form-item">
								<div class="el-form-item-div">
									<label class="el-form-item-label">工序</label>
									<input type="text" id="gx" class="el-input" placeholder="请输入工序" value="">
								</div>
							</div>
						</li>
					</ul>
...
<script src="/statics/custom/js/qc/deviation/deviationView.js?v={{$release}}"></script>
