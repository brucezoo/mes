...
<div class="page-content">
	<div class="tap-btn-wrap">
		<div class="el-form-item btnShow" style="margin-bottom: 10px;">
			<div class="el-form-item-div btn-group">
				<input type="checkbox" id="or" style="margin-top:-3px; "name="or"> <label for="or" style=" font-size:20px; margin-right: 50px;">是否生成失效</label>
				<button type="button" class="el-button el-button--primary saveMsg">添加</button>
				...
				<div class="flex-wrap" style="width: 1314px">
					<div class="basic-wrap" style="border:1px solid #ddd;">
						<div style="text-align: center;padding-top:50px;padding-bottom: 20px;">
							<h2 style="margin-bottom: 20px;">索赔单申请</h2>
						...
						<div class="userInput">
							<div class="apply">
								...
								<div class="el-form-item">
									...
									<div class="el-form-item-div abnormal-item">
										<label class="el-form-item-label" style="margin-bottom: 0px;width: 120px;margin-left: 65px;">
											<span class="">不良数量</span>
										</label>
										<input type="text" class="el-input abnormalApply-input" id="bad-num" placeholder="请输入不良数量" value="">
										<input type="hidden" class="el-input" value="">
									</div>
									<div id="select" class="el-form-item-div abnormal-item">
						...
						<div class="save-item" style="margin-top: 20px;">
								...
								<div class="el-form-item-div" style="min-width:180px !important;">
									...
									<div class="el-select-dropdown-wrap">
										<div class="el-select">
											...
											<input type="hidden" class="val_id" id="statisticsDepartment" value="">
										</div>
										<div class="el-select-dropdown">
											<ul class="el-select-dropdown-list">
											</ul>
							...
							<div class="el-form-item">
								<div class="el-form-item-div">
									<label class="el-form-item-label" style="margin-bottom: 0px;width:100px;">
										<span class="button pop-button choose-admin" style="cursor: pointer;position: relative;padding: 5px 4px;">选择审核人</span>
									</label>
									<input type="text" id="choose_admin" class="el-input" placeholder="请选择审核人" value="" readonly>
	...
	<script src="/statics/custom/js/qc/qc_inspection/addclaim.js?v={{$release}}"></script>
