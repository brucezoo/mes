          ...
          <div class="el-item-align">
            ...
            <div class="el-form-item">
              <div class="el-form-item-div">
                ...
                <input type="text" id="sales_order_project_code" class="el-input" placeholder="销售订单行项" value="">
              </div>
            </div>
          </div>
            ...
            <li>
              ...
              <div class="el-form-item">
								<div class="el-form-item-div">
									...
									<div class="el-select-dropdown-wrap show-check-status">
										<div class="el-select check_status">
											<i class="el-input-icon el-icon el-icon-caret-top"></i>
											<input type="text" readonly="readonly" class="el-input" value="--请选择--">
										...
										<div class="el-select-dropdown" style="display: none;">
											<ul class="el-select-dropdown-list show-check-status">
...
<script src="/statics/custom/js/qc/qc_inspection/inspection-oqc.js?v={{$release}}"></script>
