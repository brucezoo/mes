    ...
    <div class="el-panel-wrap">
        <form id="distribute" class="formMateriel formTemplate normal">
            <div class="flex-wrap" style="width: 1314px;">
                <div class="basic-wrap" style="border:1px solid #ddd;" id="exportWordList">
                    <div style="text-align: center;padding-top: 50px;padding-bottom: 20px;">
                        <h2 style="margin-bottom: 20px;">特采回复</h2>
                        <input id="check_code" type='hidden' value=''/>
                        <div style="text-align: right;position: relative;right: 110px;margin-bottom: 10px;">
                            ...
                            <button type="button" class="el-button primary exportWord">下载</button>
                        </div>
                    </div>
                    <div class="userInput">
                    ...
                    <div class="el-form-item">
                        <div class="el-form-item-div" style="width: 1190px;">
                            ...
                            <textarea type="textarea" maxlength="500" id="questionDescription" rows="5" class="el-textarea" readonly placeholder="">
...
<script src="/statics/custom/js/qc/deviation/viewSpecialPurchaseReply.js?v={{$release}}"></script>
