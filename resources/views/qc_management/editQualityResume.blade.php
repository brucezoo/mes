  ...
  <div class="tap-btn-wrap">
    <div class="el-form-item btnShow" style="margin-bottom: 10px;">
      <div class="el-form-item-div btn-group">
        <button type="button" class="el-button el-button--primary save">保存</button>
          ...
          <div class="save-item" style="margin-top: 20px;">
            ...
            <div class="el-form-item">
              <div class="el-form-item-div" style="width: 1190px;">
                ...
                <textarea type="textarea" maxlength="500" id="tempWay" readonly rows="5" class="el-textarea" placeholder="">
                </textarea>
              </div>
              <p class="errorMessage" style="display: block;"></p>
            </div>
            <div class="el-form-item">
              <div class="el-form-item-div" style="width: 1190px;">
                ...
                <textarea type="textarea" maxlength="500" id="finalWay" readonly rows="5" class="el-textarea" placeholder="">
            ...
            <div class="el-form-item">
              <div class="el-form-item-div" style="width: 1190px;">
                ...
                <textarea type="textarea" maxlength="500" id="resultFinalMethod" readonly rows="5" class="el-textarea" readonly placeholder="">
...
<script src="/statics/custom/js/qc/qualityResume/qc-edit-quality-resume.js?v={{$release}}"></script>
