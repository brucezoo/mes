...
<div>
	<div class="el-form-item" style="padding-right: 10px">
		<div class="el-form-item-div btn-group">
			...
			<button type="button" class="el-button el-button--primary update" style="display: none;">修改责任人</button>
		</div>
	</div>
			...
			<div style="border: solid 1px #d1dbe5; padding: 5px;">
				...
				<div style="display: flex;">
					<div class="el-form-item employee" style="width: 345px;">
						<div class="el-form-item-div" id="div">
							<input type="checkbox" id="chioce" style="margin-top: -5px; margin-right:20px;">
							<div class="div">
								<form class="layui-form" action="" id="sel">
									<label class="el-form-item-label" style="color:#000;">责任人</label>
									<div class="layui-input-inline">
										<select name="modules" lay-verify="required" lay-search="" id="selects">
											<option value="">-- 请选择或直接搜索 --</option>
										</select>
									</div>
								</form>
								<form class="layui-form" action="" style="display: none;" id="sels">
									<label class="el-form-item-label" style="color:#000;">责任人</label>
									<div class="layui-input-inline">
										<select name="modules" lay-verify="required" lay-search="" id="select">

										</select>
									</div>
								</form>
							</div>
							<div class="el-select-dropdown-wrap" style="display: none;">
								<div class="el-select">
				...
				<table id="show_in_material">
					<thead>
						<tr>
							...
							<th class="center storage">余料</th>
							<th class="center">消耗数量</th>
							<th class="center total_consume_qty">累计消耗</th>
