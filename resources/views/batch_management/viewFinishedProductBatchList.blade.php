...
<div class="div_con_wrapper">
  <input type="hidden" id="batch_view" value="/Batch/TraceBackFinishedBatch">
    ...
    <div class="wrap_table_div">
      <table id="batch_list_table" class="sticky uniquetable commontable">
        ...
        <tbody class="table_tbody">
          <tr><td colspan="7" class="center">暂无数据</td></tr>
        </tbody>
      </table>
    </div>
...
<script src="/statics/custom/js/batch/viewFinishedProductBatchList.js?v={{$release}}"></script>
