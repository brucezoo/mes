...
<div style = "">
    <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" id="ability">添加工序</button>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/translate/process.js?v={{$release}}"></script>
