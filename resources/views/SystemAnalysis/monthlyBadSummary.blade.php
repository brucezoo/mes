...
<div class="div_con_wrapper">
          ...
          <ul class="el-item-hide">
            ...
            <div class="el-form-item">
                <div class="el-form-item-div">
                  ...
                  <input type="text" id="operation_name" class="el-input" placeholder="请输入工序名称">
                </div>
              </div>
              <div class="el-form-item">
            ...
            <li>
            <div class="el-form-item">
                <div class="el-form-item-div missing-item">
                  <label class="el-form-item-label">不良项目</label>
                  <div class="el-select-dropdown-wrap">
                    <div class="el-select">
                      <i class="el-input-icon el-icon el-icon-caret-top"></i>
                      <input type="text" readonly="readonly" class="el-input" value="--请选择--">
                      <input type="hidden" class="val_id" id="missing_item">
                    </div>
                    <div class="el-select-dropdown">
                      <ul class="el-select-dropdown-list">
                        <li data-id="" data-code="" data-name="--请选择--" class=" el-select-dropdown-item">--请选择--</li>
  ...
  <div class="first-box">
    <div class="task-table-card wrap_table_div">
      <div class="table-body" style="width:100%;height:400px;display:flex;">
        <div id='main' style="width:100%;height:400px;"></div>
      </div>
      <div id='pareto' style="width:100%;height:400px;"></div>
      <div style="margin:5px;" id="monthlySummaryTable" style="overflow-x:auto;">
...
<script src="/statics/custom/js/qc/SystemAnalysis/monthly/summary.js?v={{$release}}"></script>
