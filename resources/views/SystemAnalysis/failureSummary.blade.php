...
<div class="div_con_wrapper">
      ...
      <div class="el-item">
        <div class="el-item-show">
          ...
          <ul class="el-item-hide">
            <li>
              <div class="el-form-item">
                <div class="el-form-item-div">
                  ...
                  <input type="text" id="LGFSB" class="el-input" placeholder="请输入采购仓储">
                </div>
              </div>
              <div class="el-form-item">
                <div class="el-form-item-div check_resource">
                  ...
                  <div class="el-select-dropdown-wrap">
                    <div class="el-select">
                      ...
                      <input type="hidden" class="val_id" id="check_resource" value="0">
                    </div>
            ...
            <li>
              <div class="el-form-item">
                <div class="el-form-item-div operation_id">
                  <label class="el-form-item-label">工序</label>
                  <div class="el-select-dropdown-wrap">
                    <div class="el-select">
                      <i class="el-input-icon el-icon el-icon-caret-top"></i>
                      <input type="text" readonly="readonly" class="el-input" value="--请选择--">
                      <input type="hidden" class="val_id" id="operation_id" value="0">
                    </div>
                    <div class="el-select-dropdown">
                      <ul class="el-select-dropdown-list">
                        <li data-id="" data-code="" data-name="--请选择--" class=" el-select-dropdown-item">--请选择--</li>
              ...
              <div class="el-form-item">
                <div class="el-form-item-div">
                  ...
                  <input type="text" id="NAME1" class="el-input" placeholder="请输入供应商">
                </div>
              </div>
            </li>
          </ul>
  ...
  <div class="first-box">
    <div class="task-table-card">
      <div class="table-body" id="failureSummaryTable" style="overflow-x:auto;">
...
<script src="/statics/custom/js/qc/SystemAnalysis/invalidcost/failureSummary.js?v={{$release}}"></script>
