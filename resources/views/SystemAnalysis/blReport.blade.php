...
<div class="div_con_wrapper">
      ...
      <div class="el-item">
        <div class="el-item-show">
          ...
          <ul class="el-item-hide">
            <li>
                  ...
                  <div class="el-select-dropdown-wrap">
                    ...
                    <div class="el-select-dropdown">
                      <ul class="el-select-dropdown-list">
                        ...
                        <li data-id="5" data-code="" class=" el-select-dropdown-item">委外车间补料</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="el-form-item">
                <div class="el-form-item-div status_dropdown">
                  <label class="el-form-item-label">审核状态</label>
                  <div class="el-select-dropdown-wrap">
                    <div class="el-select">
                      <i class="el-input-icon el-icon el-icon-caret-top"></i>
                      <input type="text" readonly="readonly" class="el-input" value="--请选择--">
                      <input type="hidden" class="val_id" id="repairstatus" value="1">
                    </div>
                    <div class="el-select-dropdown">
                      <ul class="el-select-dropdown-list">
                        <li data-id="" data-code="" data-name="--请选择--" class=" el-select-dropdown-item">--请选择--</li>
                        <li data-id="0" data-code="" class=" el-select-dropdown-item">未审核</li>
                        <li data-id="1" data-code="" class=" el-select-dropdown-item">已审核</li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <div class="el-form-item">
          <div class="el-form-item-div btn-group" style="margin-top: 10px;">
            ...
            <button type="button" class="el-button el-button--primary update">更新数据</button>
          </div>
        </div>
      </div>
    </form>
  ...
  <div class="first-box">
    <div class="task-table-card">
      <div class="table-body" id="blReportNumberTable" style="overflow-x:auto;">

      </div>
    </div>
    <div class="task-table-card">
      <div class="table-body" id="blReportDateTable" style="overflow-x:auto;">
...
<script src="/statics/custom/js/qc/SystemAnalysis/bl/blReport.js?v={{$release}}"></script>
