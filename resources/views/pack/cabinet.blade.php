...
@section("page-main")
    ...
    <div style="margin-bottom:20px; border-bottom:1px solid #f0f0f0;padding-bottom:20px;padding-top:10px;">
                            ...
                            <button type="button" id="btn-tp" class="layui-btn layui-btn-sm"  style=" margin-top:-2px; margin-left:20px;">添加托盘</button>
    ...
    <div id="tab" style="height:400px; width:89%; border:1px solid #333;overflow: hidden;overflow-y: auto;  display:inline-block;"  >
    ...
    <div style="margin-left:10px;  margin-top:10px;display:inline-block; width:10%; height:400px; border:1px solid #333;overflow: hidden;overflow-y: auto;">
        <table class="layui-table">
                <thead>
                    <tr>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/pack/cabinet.js?v={{$release}}"></script>
