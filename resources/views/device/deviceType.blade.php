...
@section("page-main")
    <div class="div_con_wrapper">
        ...
        <div class="actions">
            ...
            <button class="button button_action button_add_batch"><i class="fa fa-plus"></i>批量添加</button>
        </div>
...
@section("inline-bottom")
    ...
    <script src="/statics/common/pinyin/dict/pinyin_dict_withtone.js"></script>
    <script src="/statics/common/pinyin/dict/pinyin_dict_polyphone.js"></script>
    <script src="/statics/common/pinyin/pinyinUtil.js"></script>
    <script src="/statics/custom/js/device/device-url.js?v={{$release}}"></script>
    <script src="/statics/custom/js/device/device-type.js?v={{$release}}"></script>
@endsection