        ...
        <div class="tap-btn-wrap">
            <div class="el-form-item btnShow saveBtn">
                <div class="el-form-item-div btn-group">
                    <button type="button" class="el-button el-button--primary submit save">实发</button>
                    <button type="button" class="el-button submit print">打印</button>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/outsource/send_outsource_order_view.js?v={{$release}}"></script>
