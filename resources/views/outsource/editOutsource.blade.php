        ...
        <div class="tap-btn-wrap">
            <div class="el-form-item btnShow saveBtn">
                <div class="el-form-item-div btn-group">
                    ...
                    <button type="button" class="el-button el-button--primary submit deleteNotSendRow">删除未发料行项</button>
                    <button type="button" class="el-button el-button--primary submit print">打印</button>
                    <button type="button" class="el-button el-button--primary submit" style="display:none;" id="audit">审核</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div>
                    ...
                    <div class="el-form-item">
                        <div class="el-form-item-div" style="position: relative;width: 100%;">
                            ...
                            <input type="text" id="responsible" class="el-input" value="">
                        </div>
                        <p class="errorMessage" style="padding-left: 30px;"></p>
                    </div>
                </div>
