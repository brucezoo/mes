            ...
            <div class="work_order_wrap">
                ...
                <div class="work_order_right">
                    <div style="border: solid 1px #d1dbe5; padding: 5px;">
                        ...
                        <div class="op-infor" style="display: none;"><span>工序</span>：<span id="operationName"></span><div style="display: inline-block;width: 100px;"></div><span>确认号</span>：<span id="confirm_number_RUECK"></span></div>
                    </div>
                    <div>
                        <h3>消耗品</h3>
...
@section("inline-bottom")
    ...
    <script src="/statics/custom/js/outsource/outsourceMergeBusteIndex.js?v={{$release}}"></script>
