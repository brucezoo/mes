...
<style>
	...
	.glyphicon-trash,.btn-outline-secondary {
		display: none;
	}
</style>
@endsection
...
{{--重写父模板中的区块 page-main --}}
@section("page-main")
<input type="hidden" id="editurl" value="/Out/editWaterCode">
<input type="hidden" id="addurl" value="/Out/adWaterCode">
<div class="imgs-wrap">
	<div class="tap-btn-wrap">
		<div class="el-tap-wrap edit">
			<span data-item="addImage" class="el-tap active">图纸常规</span>
			<span data-item="linkImage" class="el-tap none" style="display: none;">关联图纸</span>
			<span data-item="addFujian" class="el-tap none" style="display: none;">附件</span>
			<span data-item="assemblyDrawing" class="el-tap none" style="display: none;" id="showAssemblyDrawing">组合图</span>
			<span data-item="careLable" class="el-tap none">流水码附件</span>
			<span data-item="bomList" class="el-tap none" style="display: none;">BOM</span>
		</div>
	...
	<div class="el-panel-wrap" style="margin-top: 20px;">
		...
		<div class="el-panel careLable">
			<form id="careLable" class="formMateriel formTemplate normal">
				<div class="el-form-item btnShow">
					<div class="el-form-item-div btn-group">
						<!-- <button type="button" class="el-button el-button--primary addCareLable">保存流水码</button> -->
...
<script src="/statics/custom/js/offcut/editWaterCode.js?v={{$release}}"></script>
@endsection