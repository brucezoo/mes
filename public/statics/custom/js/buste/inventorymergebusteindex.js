...
function mergeBuste(data) {
  AjaxClient.get({
    url: URLS['inventory'].moreShow + "?ids=" + data + "&" + _token,
    dataType: 'json',
    beforeSend: function () {
...
function getWorkOrderList(data) {
  ...
  data.forEach(function (item) {
        ...
        if (nitem.item_no.substring(0, 4) == '3002') {
          ...
          nbatchs.forEach(function (bitem) {
            in_material += `<tr data-id="${nitem.material_id}" data-spec_stock="${nitem.special_stock ? nitem.special_stock : ''}" data-tr='${JSON.stringify(bitem)}' data-tr-mt='${JSON.stringify(nitem)}' data-LGFSB="${nitem.LGFSB}" data-LGPRO="${nitem.LGPRO}" data-conversion="${tansferNull(bitem.conversion)}">
                        ...
                        <td><p><input type="number" min="0" max="${tansferNull(bitem.conversion > 0 ? (bitem.storage_number / bitem.conversion).toFixed(3) : bitem.storage_number)}" readonly onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')" value="${bitem.conversion > 0 ? (nitem.qty / bitem.conversion).toFixed(3) : nitem.qty}"  placeholder="" class="beath_qty deal" value="" style="line-height:20px;width: 100px;font-size: 10px;"></p></td>
                        ...
                        <td style="padding: 3px;"><input type="number" min="0" max="${tansferNull(bitem.storage_number)}" onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')"  placeholder="" class="consume_num deal" value="${bitem.conversion > 0 ? (nitem.qty / bitem.conversion).toFixed(3) : nitem.qty}" style="line-height:20px;width: 100px;font-size: 10px;"></td>
                        <td class="unit" data-unit="${nitem.bom_unit_id}">${bitem.conversion > 0 ? 'M' : nitem.bom_commercial}</td>
                        <td style="padding: 3px;"><input type="number" min="0" class="difference_num deal" value="" style="line-height:20px;width: 100px;font-size: 10px;"></td>
          ...
          nbatchs.forEach(function (bitem) {
            in_material += `<tr data-id="${nitem.material_id}" data-spec_stock="${nitem.special_stock ? nitem.special_stock : ''}" data-tr='${JSON.stringify(bitem)}' data-tr-mt='${JSON.stringify(nitem)}' data-LGFSB="${nitem.LGFSB}" data-LGPRO="${nitem.LGPRO}">
                        ...
                        <td style="padding: 3px;"><input type="number" min="0" max="${tansferNull(bitem.storage_number)}" onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')"  placeholder="" class="consume_num deal" value="${nitem.qty}" style="line-height:20px;width: 100px;font-size: 10px;"></td>
    ...
    item['out_material'].forEach(function (oitem, index) {
      ...
      //                           <td class="firm" style="padding: 3px;"><input type="number" readonly min="0" value="${tansferNull(((oitem.qty * 1000) - (aitem.GMNGA * 1000)) / 1000 < 0 ? 0 : ((oitem.qty * 1000) - (aitem.GMNGA * 1000)) / 1000)}"  onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')" placeholder="" class="consume_num deal" value="" style="line-height:20px;width: 100px;font-size: 10px;"></td>
      //                           <td class="firm" style="padding: 3px;"><input type="number" min="0" style="width: 100px;height: 30px;" onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')" class="length_for_robe deal"></td>
      //                           <td class="firm" style="padding: 3px;"><input type="text" class="unit_for_length" style="width: 100px;height: 30px;" readonly value="M"></td>
      ...
      //                           <td class="ready_id">${tansferNull(aitem.GMNGA)}</td>
      //                           <td class="unit" data-unit="${oitem.bom_unit_id}">${tansferNull(oitem.bom_commercial ? oitem.bom_commercial : '')}</td>
      //                           <td class="firm" style="padding: 3px;"><input type="number" min="0" readonly value="${tansferNull(((oitem.qty * 1000) - (aitem.GMNGA * 1000)) / 1000 < 0 ? 0 : ((oitem.qty * 1000) - (aitem.GMNGA * 1000)) / 1000)}"  onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')" placeholder="" class="consume_num deal" value="" style="line-height:20px;width: 100px;font-size: 10px;"></td>
      //                           <td class="firm" style="padding: 3px;"></td>
      //                           <td class="firm" style="padding: 3px;"></td>
      //                           <td class="firm" style="padding: 3px;">
      //                             <div class="el-select-dropdown-wrap">
      ...
      // } else {
        if (oitem.item_no.substring(0, 4) == '3002') {
          out_material += `<tr data-id="${oitem.material_id}" data-spec_stock="${oitem.special_stock ? oitem.special_stock : ''}" data-LGFSB="${oitem.LGFSB}" data-LGPRO="${oitem.LGPRO}" data-tr='${JSON.stringify(oitem)}'>
                      ...
                      <td class="unit"  data-unit="${oitem.bom_unit_id}">${tansferNull(oitem.bom_commercial ? oitem.bom_commercial : '')}</td>
                      <td class="firm" style="padding: 3px;"><input type="number" readonly min="0" value="${tansferNull(oitem.inventory_qty)}"  onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')" placeholder="" class="consume_num deal" value="" style="line-height:20px;width: 100px;font-size: 10px;"></td>
                      <td class="firm" style="padding: 3px;"><input type="number" min="0" style="width: 100px;height: 30px;" onkeyup="this.value=this.value.replace(/[^\\d.]/g,'')" class="length_for_robe deal"></td>
                      <td class="firm" style="padding: 3px;"><input type="text" class="unit_for_length" style="width: 100px;height: 30px;" readonly value="M"></td>
                      <td class="firm" style="padding: 3px;">
                        <div class="el-select-dropdown-wrap">
    ...
    <input type="hidden" class="inventory_id" value="${item['inventory_id']}"/>
...
function addBuste() {
  ...
  var dataArr = [];
  $('#workOrder_from .work_order_wrap').each(function (k, v) {
    var in_materials = [], out_materials = [],inventory_id=[];
    inventory_id.push(Number($(v).find(".inventory_id").val()));
    ...
    AjaxClient.post({
      ...
      success: function (rsp) {
        ...
        layer.confirm('工单保存成功！', {
          ...
          window.location.href = "/WorkOrder/InventoryManagement";
          // location.reload();
        });
      },
      fail: function (rsp) {
