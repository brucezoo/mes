...
function Modal(flag,type,data){
    ...
    flag==='view'?(btnShow='btnHide',readonly='readonly="readonly"'):(textareaplaceholder='请输入描述，最多只能输入800字符',flag==='add'?title='添加检验项':(title='编辑检验项',textareaplaceholder='',noEdit='readonly="readonly"'));
        ...
        content: `<form class="formModal formInspect" id="addInspect_from" data-flag="${flag}">
          ...
          <div class="el-form-item">
            <div class="el-form-item-div">
                ...
                <input type="text" id="code" ${readonly} ${noEdit} data-name="编码" class="el-input" placeholder="编码由1-10位大写字母组成" value="${object_code}">
            </div>
            <p class="errorMessage" style="padding-left: ${labelWidth}px;display: block;"></p>
          </div>
          <div class="el-form-item">
