    ...
    $('body').on('click','.choose-search',function(){
        ...
        if($(this).hasClass('choose-material')){
            ...
            ajaxData={
				...
				depot_name: parentForm.find('#stockPile').val(),
            };
            getStorageInve();
        }
						  ...
						  <li>
                              <div class="el-form-item">
                                <div class="el-form-item-div">
                                    ...
                                    <input type="text" id="stockPile" class="el-input" placeholder="请输入库存地" value="">
                                </div>
                               </div>
                          </li>
                        </ul>
