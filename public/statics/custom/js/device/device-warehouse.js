...
function getUnique(flag,field,value,id,fn){
    ...
    var xhr=AjaxClient.get({
        url: URLS['warehouseDefine'].unique+"?"+_token+urlLeft,
        dataType: 'json',
        beforeSend: function(){
...
function getOtherOption(){
    ...
    $('.table_tbody').html('');
    AjaxClient.get({
        url: URLS['warehouseDefine'].pageIndex+"?"+_token+urlLeft,
        dataType: 'json',
        beforeSend: function(){
            layerLoading = LayerConfig('load');
        },
...
function deleteOtherOption(id) {
    ...
    AjaxClient.get({
        url: URLS['warehouseDefine'].destroy+"?"+_token+"&id="+id,
        dataType: 'json',
        beforeSend: function(){
            layerLoading = LayerConfig('load');
        },
...
function viewOtherOption(id,flag){
    AjaxClient.get({
        url: URLS['warehouseDefine'].show+"?"+_token+"&id="+id,
        dataType: 'json',
        beforeSend: function(){
            layerLoading = LayerConfig('load');
        },
...
function editOtherOption(data) {
    AjaxClient.post({
        url: URLS['warehouseDefine'].update,
        data: data,
        dataType: 'json',
        beforeSend: function(){
            layerLoading = LayerConfig('load');
...
function addOtherOption(data) {
    AjaxClient.post({
        url: URLS['warehouseDefine'].store,
        data: data,
        dataType: 'json',
        beforeSend: function(){
            layerLoading = LayerConfig('load');
