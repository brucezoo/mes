...
function emi2cRoutingGraph(parentElementName, routingGraph, width, height) {
    ...
    if (this.parent.length) {
        ...
        legendBox.append('<div class="heading"><strong>节点类型<strong></div>');
        //create the table which holds the routing mode color descriptions
        var legendTable = $('<table class="legend_table"></table>');
        legendTable.append('<tr><td><canvas class="required" width="36" height="36"></canvas></td><td>必选</td></tr>');
        legendTable.append('<tr><td><canvas class="skippable" width="36" height="36"></canvas></td><td>可跳过</td></tr>');
        legendTable.append('<tr><td><canvas class="selectable" width="36" height="36"></canvas></td><td>可选择</td></tr>');
        legendTable.append('<tr><td><canvas class="skippable_selectable" width="36" height="36"></canvas></td><td>跳过并可选</td></tr>');
